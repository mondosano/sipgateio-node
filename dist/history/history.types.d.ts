...
export interface HistoryModule {
    fetchAll: (filter?: HistoryFilter, pagination?: Pagination) => Promise<HistoryEntry[]>;
    ...
    batchUpdateEvents: (events: HistoryEntry[], callback: (entry: HistoryEntry) => HistoryEntryUpdateOptions) => Promise<void>;
    exportAsCsvString: (filter?: BaseHistoryFilter, pagination?: Pagination) => Promise<string>;
}
...
export interface HistoryEntryUpdateOptionsWithId extends HistoryEntryUpdateOptions {
    id: string;
}
...
export declare enum HistoryDirection {
    INCOMING = "INCOMING",
    OUTGOING = "OUTGOING",
    MISSED_INCOMING = "MISSED_INCOMING",
    MISSED_OUTGOING = "MISSED_OUTGOING"
}
export declare enum Starred {
    STARRED = "STARRED",
    UNSTARRED = "UNSTARRED"
}
...
declare type HistoryResponseFaxItem = Omit<FaxHistoryEntry, 'faxStatus'> & {
    faxStatusType: FaxStatusType;
};
export declare enum FaxStatusType {
    PENDING = "PENDING",
    SENDING = "SENDING",
    FAILED = "FAILED",
    SENT = "SENT",
...
export declare enum CallStatusType {
    SUCCESS = "SUCCESS",
    FAILURE = "FAILURE",
    REJECTED = "REJECTED",
...
export declare type HistoryEntry = CallHistoryEntry | FaxHistoryEntry | SmsHistoryEntry | VoicemailHistoryEntry;
export declare type HistoryResponseItem = Exclude<HistoryEntry, FaxHistoryEntry> | HistoryResponseFaxItem;
